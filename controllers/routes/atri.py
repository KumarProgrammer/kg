...
class Atri:
	def __init__(self, state: Any):
		...
		self.BarChartmy = state["BarChartmy"]
		self.Alert1 = state["Alert1"]
		self._setter_access_tracker = {}
	...
	@property
	def BarChartmy(self):
		self._getter_access_tracker["BarChartmy"] = {}
		return self._BarChartmy
	@BarChartmy.setter
	def BarChartmy(self, new_state):
		self._setter_access_tracker["BarChartmy"] = {}
		global default_state
		self._BarChartmy = BarChart(new_state, default_state["BarChartmy"])

	@property
	def Alert1(self):
		self._getter_access_tracker["Alert1"] = {}
		return self._Alert1
	@Alert1.setter
	def Alert1(self, new_state):
		self._setter_access_tracker["Alert1"] = {}
		global default_state
		self._Alert1 = Alert(new_state, default_state["Alert1"])

	def _to_json_fields(self):
		return {
			"Flex1": self._Flex1,
			"BarChartmy": self._BarChartmy,
			"Alert1": self._Alert1,
			}
