...
default_state = json.loads('{"BarChartmy":{"styles":{"width":"","height":"","minWidth":"","minHeight":"","maxWidth":"","maxHeight":"","overflow":""},"custom":{"cartesianGrid":{"show":false,"strokeDasharray":""},"data":[],"xAxis":{"show":false,"key":""},"yAxis":{"show":false},"toolTip":{"show":false},"legend":{"show":false},"stacked":false,"options":{}}}}')
